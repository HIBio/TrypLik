...
Install the development version from [GitHub](https://github.com/HIBio/TrypLik) with:
...
commented out. The R wrapper uses the file [`src/tryplik.c`](src/tryplik.c)
which only differs in the additional R components.
...
* Package development is possible thanks to `r BiocStyle::CRANpkg('usethis')`, `r BiocStyle::CRANpkg('remotes')`, and `r BiocStyle::CRANpkg('rcmdcheck')` customized to use [Bioconductor's docker containers](https://www.bioconductor.org/help/docker/) and `r BiocStyle::Biocpkg('BiocCheck')`.
